...
const ShoppingCart = ({ isCartOpen, setIsCartOpen }) => {
  ...
  const handleCheckout = useCallback(async () => {
    ...
    try {
      ...
      // Don't clear cart here, clear it on the success page.
      ...
      {isCartOpen && (
        ...
        >
          <motion.div
            ...
            className="absolute right-0 top-0 h-full w-full max-w-md bg-[#111827] shadow-2xl flex flex-col"
